<?php
    ...
    if(!empty($_POST)){
        ...
        if($validation->passed()){
            $currentHeader = DB::getInstance()->findFirst("faq",  [
                'conditions' => 'id = ?',
                'bind' => [$headerTitle]
            ]);
            ...
            DB::getInstance()->update('faq', $headerTitle, array(
...
<div class="background">
    ...
    <div class="center-components" id="center-components"> 
        ...
        <form action="add-faq-page-paragraph.php" method="POST" id="add-paragraph-form">
